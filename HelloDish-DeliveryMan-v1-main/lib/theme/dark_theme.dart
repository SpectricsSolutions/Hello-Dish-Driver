...
ThemeData dark = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFFD23838))),
  colorScheme: const ColorScheme.dark(primary: Color(0xFFD23838), secondary: Color(0xFFD23838)).copyWith(error: const Color(0xFFD23838)),
